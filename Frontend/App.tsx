...
const FindStackNavigator = () => (
  <Stack.Navigator screenOptions={{ headerShown: false }}>
    <Stack.Screen name="InitialSearch" component={InitialSearchScreen} />
    <Stack.Screen
      name="Results"
...
const App = () => {
  ...
  // Initialize Analytics one time
useEffect(() => {
  initAnalytics();
  
  // Log a test event after a short delay
  setTimeout(() => {
    logEvent('app_opened', { timestamp: new Date().toISOString() });
  }, 2000);
}, []);
